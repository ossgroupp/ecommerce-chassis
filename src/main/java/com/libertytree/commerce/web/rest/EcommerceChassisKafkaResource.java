...
@RestController
@RequestMapping("/api/ecommerce-chassis-kafka")
public class EcommerceChassisKafkaResource {

    private final Logger log = LoggerFactory.getLogger(EcommerceChassisKafkaResource.class);
    ...
    public EcommerceChassisKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
